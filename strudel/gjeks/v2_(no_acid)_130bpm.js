...
n("1!2 2*4 1*2@2 3*2 3*2 <4*2 <1 1 1 -1>>")
  ...
  .distort(tri.range(1.5, 2).fast(2)).gain(tri.range(.01, .05).fast(2)) //0.1 starting gain good too
...
acid: n("1*2 2*2 1*2 1*2 1*2 2*2 1*2 <3*2 <1 1 1 -10>>")
  ...
  // .scale("C2:major")
  .lpf(saw.range(slider(1500, 1200, 1700, 100).fast(4), 2000).fast(16)) //switch the range start to get different acids
